...
certPath = "/home/pi/AWS/5be11ee507e8f93438f5c7e8df5df678603c4ba18cc9d14106ca48fdbecaabca-certificate.pem.crt"                            # <Thing_Name>.cert.pem
keyPath = "/home/pi/AWS/5be11ee507e8f93438f5c7e8df5df678603c4ba18cc9d14106ca48fdbecaabca-private.pem.key"                          # <Thing_Name>.private.key
...
while 1==1:
    ...
    if connflag == True:
        ...
        mqttc.publish("RaspberryPiData", paylodmsg_json , qos=1)        # topic: temperature # Publishing Temperature values
        print("msg sent: RaspberryPiData" ) # Print sent temperature msg on console
